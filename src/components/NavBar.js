...
const NavBar = () => {
  ...
  return (
    <header className=' w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8 '>
        ...
        <button className='flex-col justify-center items-center hidden lg:flex mt-5 sm:mt-1' 
        onClick={handleClick}
        >
        ...
        </div>
        {
            ...
            <nav className='flex items-center justify-center flex-wrap mt-2'>
                ...
                whileHover={{y: -2}}
                whileTap={{scale: 0.9}}
                className='w-6 mx-3 sm:mx-1 bg-light dark:bg-dark rounded-full'><GithubIcon /></motion.a>
                <motion.a href='https://twitter.com' target={'_blank'}
                whileHover={{y: -2}}
                whileTap={{scale: 0.9}}
                ...
                whileHover={{y: -2}}
                whileTap={{scale: 0.9}}
                className='w-6 mx-3 sm:mx-1'><PinterestIcon /></motion.a>
                <motion.a href='https://twitter.com' target={'_blank'}
                whileHover={{y: -2}}
                whileTap={{scale: 0.9}}
