...
const FeaturedProject = ({type, title, summary, img, link, github}) => {
  ...
  return(
    <article className='w-full flex items-center justify-between rounded-3xl border border-sold border-dark bg-light shadow-2xl p-12 relative rounded-br-2xl dark:bg-dark dark:border-light
...
<Link className='w-full cursor-pointer overflow-hidden rounded-lg' href={link} target='_blank'>
    ...
    <Link href={link} target='_blank' className='text-dark  dark:text-light p-2 text-lg font-semibold underline md:text-base '>Visit</Link>
    ...
    <Head>
      ...
      <main className='w-full mb-16 flex flex-col items-center justify-center dark:text-light'>
        <Layout className='pt-16'>
            <AnimatedText  className='mb-16 lg:!text-7x sm:mb-8 sm:!text-6xl xs:!text-4xl ' text={'Imagination Trumps Knowledge!'}/>
